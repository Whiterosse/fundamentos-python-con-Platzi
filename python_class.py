...
# Ejercicio 8: Escribir un programa que solicite al usuario ingresar su salario y determine si es elegible
# para recibir un aumento, considerando que el salario mínimo para ser elegible es de $1000.
"""
...
if salario <= sm:
    print("Acto para aumento")
else:
    print("nooooooo! ya ganas suficiente")
"""

# Ejercicio 9: Escribir un programa que solicite al usuario ingresar un número y determine si es un número perfecto o no,
# considerando que un número perfecto es aquel que es igual a la suma de sus divisores propios.
...
if suma == numero:
    print(f"el {numero} es perfecto")
else:
    print(f" el {numero} no es perfecto F")
"""
